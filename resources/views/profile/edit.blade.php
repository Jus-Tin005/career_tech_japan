      ...
      <div class="col-xl-4">
        ...
        <div class="card">
          <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
            ...
            <img src="{{ asset('assets/image/profile/profile.jpg') }}" alt="Profile" class="rounded-circle">
            <h2>{{ $authUser->name ?? null }}</h2>
            <h3>{{ $authUser->email ?? null }}</h3>
                ...
                <form>
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <img src="{{ asset('assets/image/profile/profile.jpg') }}" alt="Profile">
                      <div class="pt-2">
